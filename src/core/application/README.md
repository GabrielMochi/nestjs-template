...
- **Ports** – Define interfaces (Input/Output) to interact with presentation layers.
- **Services** – Implement domain logic while keeping dependencies minimal.

## Why?

This layer orchestrates business logic while remaining **decoupled** from external frameworks and presentation.
